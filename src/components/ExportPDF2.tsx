...
function ExportPDF2({ result }: ExportPDF2Props) {
  const handleExport = async () => {
    ...
    content.innerHTML = `
      <div style="background-color: #0030b9; padding: 24px 40px; font-family: Arial, sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
          <div style="background-color: rgba(255, 255, 255, 0.1); padding: 24px; border-radius: 12px; height: 320px; display: flex; flex-direction: column;">
            <h3 style="font-size: 22px; font-weight: bold; color: white; margin: 0 0 20px 0;">Dados da Empresa</h3>
            <div style="display: grid; gap: 16px; font-size: 16px; flex: 1; justify-content: center;">
          ...
          <div style="background-color: rgba(255, 255, 255, 0.1); padding: 24px; border-radius: 12px; height: 320px; display: flex; flex-direction: column;">
            <h3 style="font-size: 22px; font-weight: bold; color: white; margin: 0 0 20px 0;">Dados do Negócio</h3>
            <div style="display: grid; gap: 16px; font-size: 16px; flex: 1; justify-content: center;">
